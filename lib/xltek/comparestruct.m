function [fs1, fs2, er] = comparestruct(s1,s2,n1,n2,p,tol)
...
%
% example:	[r1 r2] = comparestruct(data1,data2,'data1','data2',1)
...
if nargin < 1; help comparestruct; error(['matlab:' mfilename],'I / O error'); end
...
%			clean display - add index if needed
			...
			[fss1 fss2 err] = comparestruct(getfield(s1(jj),char(fn1(pnt1i(ii)))), ...
