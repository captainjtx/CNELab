...
idx=ismember(close.channame,hfb_chan);
...
ttest2(10*log10(mean(small_lfb,2)),10*log10(mean(large_lfb,2)),'tail','right')
ttest2(10*log10(mean(small_hfb,2)),10*log10(mean(large_hfb,2)),'tail','right')
ttest2(10*log10(mean(small_ufb,2)),10*log10(mean(large_ufb,2)),'tail','right')
title(s);
%
hold on
