classdef CovMapWindow < handle
    ...
    methods
        ...
        function buildfig(obj)
            ...
            obj.pos_radio=uicontrol('parent',covp,'style','radiobutton','string','++ Threshold:','units','normalized',...
            ...
            obj.multi_pos_radio=uicontrol('parent',covp,'style','radiobutton','string','Multi Threshold:','units','normalized',...
            ...
            obj.neg_radio=uicontrol('parent',covp,'style','radiobutton','string','--- Threshold:','units','normalized',...
            ...
            obj.multi_neg_radio=uicontrol('parent',covp,'style','radiobutton','string','Multi Threshold:','units','normalized',...
