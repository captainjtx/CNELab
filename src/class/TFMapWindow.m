    ...
    methods
        ...
        function buildfig(obj)
            ...
            obj.method_popup=uicontrol('Parent',hp_method,'Style','popup',...
                'String',{'Channel','Average','Grid'},'units','normalized','Position',[0.4,0,0.59,0.95]);
            ...
            obj.data_popup=uicontrol('Parent',hp_data,'Style','popup',...
                'String',{'Selection','Single Event','Average Event'},'units','normalized','position',[0.4,0.6,0.59,0.39],...
