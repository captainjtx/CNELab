...
uicontrol(obj.FilterPanel,'Style','text','String','Notch:','units','normalized','position',[.46 .2 .1 .6],'HorizontalAlignment','right',...
    'FontUnits','normalized','FontSize',0.55);
obj.EdtFilterNotch=uicontrol(obj.FilterPanel,'Style','edit','units','normalized','position',[.6 .1 .1 .8],'BackgroundColor',[1 1 1],...
    'Callback',@(src,evt) ChangeFilter(obj,src),'String','-');
