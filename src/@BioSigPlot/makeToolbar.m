...
obj.JTogMontage=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/Raw.png'],btn_d,char('Raw montage'),col));
...
obj.JTogComAve=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/common.png'],btn_d,char('Mean reference'),col));
...
obj.JBtnSwitchData=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/switch.png'],btn_d,char('Next data'),col));
...
obj.JTogHorizontal=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/horizontal.png'],btn_d,char('Horizontal Alignment'),col));
...
obj.JTogVertical=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/vertical.png'],btn_d,char('Vertical Alignment'),col));
...
obj.JBtnPlaySlower=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/slower.png'],btn_d,char('Slower'),col));
...
obj.JTogPlay=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/play.png'],btn_d,char('Start'),col));
set(handle(obj.JTogPlay,'CallbackProperties'),'MousePressedCallback',@(h,e) StartPlay(obj));
obj.JToolbar(1).add(obj.JTogPlay);

obj.JBtnPlayFaster=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/faster.png'],btn_d,char('Faster'),col));
...
obj.JTogVideo=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/video.png'],btn_d,char('Video'),col));
...
obj.JBtnWidthIncrease=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/time_increase.png'],btn_d,char('Increase time'),col));
...
obj.JBtnWidthDecrease=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/time_decrease.png'],btn_d,char('Decrease time'),col));
...
obj.JBtnHeightIncrease=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/chan_increase.png'],btn_d,char('Increase chan'),col));
...
obj.JBtnHeightDecrease=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/chan_decrease.png'],btn_d,char('Decrease chan'),col));
...
obj.JBtnGainIncrease=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/zoom_in.png'],btn_d,char('Increase gain (ctrl =)'),col));
...
obj.JBtnGainDecrease=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/zoom_out.png'],btn_d,char('Decrease gain (ctrl -)'),col));
...
obj.JBtnAutoScale=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/auto.png'],btn_d,char('Auto gain'),col));
...
obj.JBtnMaskChannel=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/mask.png'],btn_d,char('Mask channel'),col));
...
obj.JBtnUnMaskChannel=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/unmask.png'],btn_d,char('Unmask channel'),col));
...
obj.JTogSelection=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/select.png'],btn_d,char('Selection'),col));
...
obj.JBtnSelectWin=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/select_win.png'],btn_d,char('Select window'),col));
...
obj.JTogMeasurer=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/measurer.png'],btn_d,char('Amplitude measurer'),col));
...
obj.JTogAnnotate=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/evts.png'],btn_d,char('Annotate (ctrl i)'),col));
...
obj.JBtnPSD=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/psd.png'],btn_d,char('Power Spectrum Density'),col));
...
obj.JBtnTFMap=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/tfmap.png'],btn_d,char('Time-Frequency Map'),col));
...
obj.JBtnPCA=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/pca.png'],btn_d,char('Principle Component Analysis'),col));
set(handle(obj.JBtnPCA,'CallbackProperties'),'MousePressedCallback',@(h,e) SPF_Analysis(obj,'pca'));
obj.JToolbar(1).add(obj.JBtnPCA);

obj.JToolbar(1).addSeparator();

obj.JBtnICA=javaObjectEDT(TButton([char(globalVar.CNELAB_PATH),'/db/icon/ica.png'],btn_d,char('Independent Component Analysis'),col));
