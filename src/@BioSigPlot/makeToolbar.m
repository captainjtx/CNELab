...
obj.JBtnWidthIncrease=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/time_increase.png'],btn_d,char('Increase time'),col));
...
obj.JBtnWidthDecrease=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/time_decrease.png'],btn_d,char('Decrease time'),col));
...
obj.JBtnHeightIncrease=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/chan_increase.png'],btn_d,char('Increase chan'),col));
...
obj.JBtnHeightDecrease=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/chan_decrease.png'],btn_d,char('Decrease chan'),col));
