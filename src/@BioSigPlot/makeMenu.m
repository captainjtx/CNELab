...
obj.MenuMeanRef=uimenu(obj.MenuApp,'Label','Mean Reference',...
    'Callback', @(src,evt) Mean_Reference_Filter(obj));
obj.MenuRemovePulse=uimenu(obj.MenuApp,'Label','Pulse Artifact Remove',...
    'Callback', @(src,evt) Auto_Remove_Pulse_Artifact(obj));
obj.MenuTemporalPCA=uimenu(obj.MenuApp,'Label','Temporal PCA',...
