...
obj.Fig=figure('MenuBar','none','ToolBar','none','DockControls','off','NumberTitle','off','Renderer','opengl',...
    ...
    'WindowKeyPressFcn',@(src,evt) KeyPress(obj,src,evt),'WindowKeyReleaseFcn',@(src,evt) KeyRelease(obj,src,evt),'Units','Pixels','Visible','off');
...
obj.MainPanel=uipanel(obj.Fig,'units','pixels','BorderType','none');
obj.ControlPanel=uipanel(obj.Fig,'units','pixels','BorderType','none');
...
obj.EventPanel=uipanel(obj.Fig,'units','pixels','BorderType','none','position',[0,0,obj.EventPanelWidth,100]);
