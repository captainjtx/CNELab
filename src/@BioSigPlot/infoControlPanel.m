...
obj.TxtY=uicontrol(obj.InfoPanel,'Style','text','units','normalized','position',[0 0.68 1 .3],...
...
obj.TxtFilter=uicontrol(obj.InfoPanel,'Style','text','units','normalized','position',[0 0.02 1 .3],...
