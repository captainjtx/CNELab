...
obj.BtnPlaySlower=uitoggletool(obj.Toolbar,'CData',imread('slower.bmp'),'separator','on',...
    'ClickedCallback',@(src,evt) PlaySlower(obj));
obj.TogPlay=uitoggletool(obj.Toolbar,'CData',obj.IconPlay,...
    'ClickedCallback',@(src,evt) StartPlay(obj),'State','off');
obj.BtnPlayFaster=uitoggletool(obj.Toolbar,'CData',imread('faster.bmp'),...
    'ClickedCallback',@(src,evt) PlayFaster(obj));
obj.TogVideo=uitoggletool(obj.Toolbar,'CData',imread('video.bmp'),'TooltipString','Video Window',...
    'ClickedCallback',@(src,evt) WinVideoFcn(obj));
