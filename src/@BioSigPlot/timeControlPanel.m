...
obj.JBtnStart=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/start.png'],btn_d,char('start'),col));
...
obj.JBtnPrevPage=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/prev_page.png'],btn_d,char('previous page (shift + left)'),col));
...
obj.JBtnPrevSec=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/prev_sec.png'],btn_d,char('backward (ctrl + left)'),col));
...
obj.JBtnNextSec=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/next_sec.png'],btn_d,char('forward (ctrl + right)'),col));
...
obj.JBtnNextPage=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/next_page.png'],btn_d,char('next page (shift + right)'),col));
...
obj.JBtnEnd=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/end.png'],btn_d,char('end'),col));
