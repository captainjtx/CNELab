...
obj.TFMap=uipushtool(obj.Toolbar,'CData',imread('tfmap.bmp'),'TooltipString','Time-Frequency map',...
...
obj.TogSelection=uitoggletool(obj.Toolbar,'CData',imread('select.bmp'),'TooltipString','Selection(ctrl e)',...
    'ClickedCallback',@(src,evt) ChangeMouseMode(obj,src));
