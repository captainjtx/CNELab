...
%             obj.JNewBtn=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/new.png'],btn_d,char('Recenter'),col));
%             set(handle(obj.JRecenter,'CallbackProperties'),'MousePressedCallback',@(h,e) RecenterCallback(obj));


width=position(4)/position(3);

obj.JLoadBtn=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/load_vol.png'],btn_d,char('Load volume'),col));
...
obj.JDeleteBtn=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/delete_vol.png'],btn_d,char('Delete volume'),col));
...
obj.JNewBtn=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/new_vol.png'],btn_d,char('New volume'),col));
...
obj.JSaveBtn=javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/save_vol.png'],btn_d,char('Save volume'),col));
...
obj.JExtraBtn1 = javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/interpolate.png'],btn_d,char('Interpolate'),col));
...
obj.JExtraBtn2 = javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/map.png'],btn_d,char('Load map'),col));
...
obj.JSettingsBtn = javaObjectEDT(PushButton([obj.cnelab_path,'/db/icon/more.png'],btn_d,char('More'),col));
